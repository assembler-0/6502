    ...
    void Execute(u32 Cycles, MEM& Memory){
        while (Cycles > 0){
            ...
            switch (Instruction){
                ...
                default: {
                    std::cout << "Instruction not handled: " << (int)Instruction << std::endl;
...
int main(){
    ...
    std::cout << "Value at 0x10: " << (int)mem[0x10] << std::endl;
    std::cout << "Zero Flag: " << (int)cpu.Z << std::endl;
    std::cout << "Final PC: " << cpu.PC << std::endl;
